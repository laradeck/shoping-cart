...
A simple shoppingcart implementation for Laravel. Based on [LaravelShoppingcart](https://github.com/Crinsane/LaravelShoppingcart)
...
Run the Composer require command from the Terminal:
    ...
    composer require laradeck/shopping-cart
